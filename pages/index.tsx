...
import ChampionCaption from "../components/ChampionCaption";
...
const roles = [
  {
    ...
    img: "https://www.leagueoflegends.com/static/assassin-d64d3ffdda15e1eed637aefe6a2c7fee.png",
    role: "Assassins",
  },
  {
    id: "r2",
    name: "Yasuo",
    title: "Disgracié",
    img: "https://www.leagueoflegends.com/static/fighter-7a08920b696ecdb673edeeae1d3c616e.png",
    role: "Combattants",
  },
  {
    id: "r3",
    ...
    img: "https://www.leagueoflegends.com/static/mage-3bfa6dfe620adafe5e539c2e470f4acc.png",
    role: "Mages",
  },
  {
    id: "r4",
    ...
    img: "https://www.leagueoflegends.com/static/marksman-b339ed8fd7e04ff2c3fca022c5d299fb.png",
    role: "Tireurs",
  },
  {
    id: "r5",
    ...
    img: "https://www.leagueoflegends.com/static/support-d63ae08baf517425864ddc020a5871d5.png",
    role: "Supports",
  },
  {
    id: "r6",
    name: "Leona",
    title: "Aube radieuse",
    img: "https://www.leagueoflegends.com/static/tank-1245abc326bd98c567ab22659719a1a3.png",
    role: "Tanks",
  },
];
...
const Background = () => {
  return (
    <div className={styles.backgroundRoot}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={styles.bg}>
...
const Preview = () => {
  ...
  return (
    <div className={styles.previewRoot}>
      <RoleSelector data={roles} onClick={setSelectedRole} />

      <div className={styles.wrapperChampion}>
        {roles.map(({ id, img }, index) => <ChampionImage key={id} img={img} isActive={index === selectedRole} />)}
      </div>
      {/* {roles.map(({ id, name, title }, index) => <ChampionCaption key={id} name={name} title={title} isActive={index === selectedRole} />)} */}
    </div>
  )
}
  ...
  return (
    <>
      ...
      <section className={styles.root}>
        ...
        <div className={styles.middlePan}>
          <Title />
          <Preview />
        </div>
